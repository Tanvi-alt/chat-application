...
//Get all messages for seelcted user

export const getMessages = async ( req, res) =>{
    try {
        const { id : selectedUserId } = req.params;//storing id as selecteduserId
...
//api to mark messages as seen with using message id
